...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("PCNET-IT-Connect".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["suporte.pcnet-it.com.br"];
pub const RS_PUB_KEY: &str = "vP9CxQ6rbAyxvShg31BoSMbKUzcMm1669UHjXbZSZ+0=";
