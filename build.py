...
def build_flutter_windows(version, features, skip_portable_pack):
    ...
    system2(
        f'python3 ./generate.py -f ../../{flutter_build_dir_2} -o . -e ../../{flutter_build_dir_2}/PCNET-IT-Connect.exe')
    os.chdir('../..')
    ...
    os.rename('./rustdesk_portable.exe', f'./PCNET-IT-Connect-{version}-install.exe')
    print(
...
def main():
    ...
    if windows:
        ...
        # system2('upx.exe target/release/PCNET-IT-Connect.exe')
        ...
        system2('pip3 install -r requirements.txt')
        system2(
            f'python3 ./generate.py -f ../../{res_dir} -o . -e ../../{res_dir}/PCNET-IT-Connect-{version}-win7-install.exe')
        system2(f'mv ../../{res_dir}/PCNET-IT-Connect-{version}-win7-install.exe ../..')
