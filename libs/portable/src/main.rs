...
const APP_PREFIX: &str = "PCNET-IT-Connect";
...
mod win {
    ...
    pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_pcnetit.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &Path) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_pcnetit.exe"])
